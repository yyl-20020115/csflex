...
public class Timer
{
    ...
    public Timer()
    {
        startTime = Stopwatch.GetTimestamp();// java_cup.Support.currentTimeMillis();
        running = true;
    }
    ...
    public void Stop()
    {
        stopTime = Stopwatch.GetTimestamp(); //java_cup.Support.currentTimeMillis();
        running = false;
    }
     ...
     */
    public long Diff => running ? Stopwatch.GetTimestamp() - startTime : stopTime - startTime;
